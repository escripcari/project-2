...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <p>Общая стоимость: <b>{{$order->getFullPrice()}} лей</b></p>
                ...
                <div>
                    ...
                    <div class="container">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="phone" id="phone" value="{{session('phone')}}" class="form-control">
                            </div>
                        </div>
                        <br>
                        <br>
                    ...
                    <br>
                    @csrf
                    <input id="submit" type="submit" class="btn btn-success" value="Подтвердите заказ">
                </div>
            </form>
        </div>
    </div>

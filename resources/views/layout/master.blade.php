        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                @if(!is_null(session('orderId')))
                    <li><a href={{route('basket')}}>В корзину [{{session('basketCount') ? session('basketCount') : " "}}]</a></li>
                @endif
            ...
            <ul class="nav navbar-nav navbar-right">
                @guest()
                    <li><a href="{{route('login')}}">Понель администратора</a></li>
                    <li><a href="{{route('login')}}">Войти</a></li>
                @endguest

                @auth()
                    <li><a href="{{route('home')}}">Понель администратора</a></li>
